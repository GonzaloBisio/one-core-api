-- =================================================================
-- SCRIPT PARA CREAR TABLAS EN EL SCHEMA DE UN TENANT (Ej: tenant_empresa_test)
-- (Versión simplificada SIN tablas tenant_users/tenant_roles internas)
-- =================================================================

-- Tablas que ya definimos (Suppliers, ProductCategories, Products, StockMovements, Customers)
-- ahora con FKs a public.system_users donde aplique.
